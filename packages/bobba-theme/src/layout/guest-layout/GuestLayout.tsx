...
import {configContext, GuestGuard, Icon} from '@instinct-web/core';
                ...
                <div className="row">
                  ...
                  <div className="col text-left">
                    ...
                    <div
                      ...
                      style={{fontSize: 20, color: 'white'}}
                    >
                      {config.siteName} will consist of general and private
                      rooms where player can interact with each other through
